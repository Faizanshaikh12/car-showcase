...
const CarDetails = ({ car, open, closeModel }: CarDetailsProps) => {
    return (
        <>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                ...
                                overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl flex flex-col gap-5 transition-all">
                                    <button
                                        type="button"
                                        onClick={closeModel}
